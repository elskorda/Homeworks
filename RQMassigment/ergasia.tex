...
\usepackage{caption,fullpage,amsmath,amssymb,mdframed,stackrel}
...
\input{eidikisxet.tex}
\pagebreak
%-----------------------------------------
%eksiswsi KleinGordon
\input{kleinGordon.tex}
\pagebreak
%-----------------------------------------
%mn sxetikistiko orio KleinGordon
\input{nonrelatKG.tex}
\pagebreak
%-----------------------------------------
%eksiswsi Dirac
\input{Dirac.tex}
